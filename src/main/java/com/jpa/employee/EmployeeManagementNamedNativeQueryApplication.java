...
public class EmployeeManagementNamedNativeQueryApplication implements CommandLineRunner {

	@Autowired
	private EmployeeService employeeService;
	
	public static void main(String[] args) {
		SpringApplication.run(EmployeeManagementNamedNativeQueryApplication.class, args);
	}
	...
	{
		Employee employee = new Employee("shravani","mahalle","shravni98@gmail.com",new Date());
